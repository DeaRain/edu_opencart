              ...
              <div class="right-drop-list__container">
                <div class="widget qtranxs_widget">
                  <ul class="language-chooser">
                    <li class="language-chooser-item"><a class="right-drop-list__item" href="#">ua</a></li>
                    <li class="language-chooser-item"><a class="right-drop-list__item" href="#">RU</a></li>
                    <li class="language-chooser-item"><a class="right-drop-list__item" href="#">EN</a></li>
                  </ul>
                </div>
              </div>
            </div>
